<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/UserMaster.Master" AutoEventWireup="true" CodeBehind="SteganographyText.aspx.cs" Inherits="ISECCS_PJ.UserPage.SteganographyText" %>
    ...
    <div style="margin-top: 50px; margin-left: 200px;">
        ...
        <div style="font-size: 20px;">
            <table class="nav-justified">
                ...
                <tr>
                    <td class="modal-sm" style="width: 340px">
                        <asp:TextBox ID="tb_textToHide" runat="server" Width="320px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
