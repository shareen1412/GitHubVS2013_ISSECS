        ...
        <table class="nav-justified">
            <table align="center">
                ...
                <tr>
                    ...
                    <td style="height: 62px">
                        <asp:TextBox ID="tb_password" runat="server" Height="30px" Width="300px" TextMode="Password" oncopy="return false" onpaste="return false" oncut="return false" ondelete="return false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btn_login" runat="server" Text="Login" Width="100px" OnClick="btn_login_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
